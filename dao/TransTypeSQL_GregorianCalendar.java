...
public class TransTypeSQL_GregorianCalendar{
	...
	public static GregorianCalendar GregorianCalendarfromDate(Date date) throws ParseException {
		GregorianCalendar rep= new GregorianCalendar();
		rep.setTime(date);
		return rep;
	}
	...
	public static Timestamp DateToTimestamp(Date date) throws ParseException {
		return SQLTimeStampFromGregorianCalendar(GregorianCalendarfromDate(date));
	}
