...
public class Plateau_Memori {
	...
	public Plateau_Memori(long tempsDeJeuMillis, Date date_derniere_utilisation, List<Joueur> joueursDB, int indexDB, int id_plateauDB)
	{
